					...
					<form method="POST">
						...
						<div class="form-group">
							<input type="password" id="confirmPwd" name="confirmPwd" class="form-control"
								onkeyup="check('confirmPwd', 'warn-confirm')" placeholder="Confirm Password">
...
if (isset($_POST['fullName'])) {
	...
	if ($fullName != "" && $email != "" && $phone != "" && $address != "" && $password != "") {
		...
		if ($exist['user_id'] != null) {
			...
			$sql = "INSERT INTO user (email, phone_number, address, password, full_name) VALUES ('$email', '$phone', '$address', '$password', '$fullName')";
